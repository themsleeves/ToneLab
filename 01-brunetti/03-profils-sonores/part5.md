...
[← Partie 4 — Profils adaptés aux guitares](part4.md)

[→ Partie 6 — Profils musicaux](part6.md)
...
- resserrer le comportement du grave ;
- renforcer l'attaque ;
- améliorer la définition.

Le MXR peut notamment servir à :

- corriger un déséquilibre ;
- accentuer une zone fréquentielle ;
- adapter un profil à une guitare ;
